...
private:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Frontent Tab List Settings", meta = (AllowPrivateAccess = "true", ClampMin = "1", ClampMax = "10"))
	int32 DebugEditorPreviewTabCount = 3;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Frontent Tab List Settings", meta = (AllowPrivateAccess = "true"))
